...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      ...
      <body
        className={`${manrope.variable} flex min-h-dvh flex-col items-center justify-start overflow-x-hidden bg-[#080C20] pb-[117px] pt-[81px] font-manrope sm:min-h-screen`}
      >
