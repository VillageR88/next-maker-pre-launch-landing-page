...
export default function MainRow1() {
  return (
    <div className="flex h-[459px]  w-[1553px] justify-between">
      <Image width={408} height={459} src={imageHeroLeft as string} alt="image of people" />
      <div className="flex h-[318px] w-[730px] flex-col items-center pr-[19px] text-white">
        ...
        <Image width={26} height={42} className="mt-[64px]" src={imageScroll as string} alt="scroll image" />
      </div>
      <Image width={396} height={444} src={imageHeroRight as string} alt="image of people" />
    </div>
  );
}
